...
namespace AG\PasswordGenerator\Widget;

defined('ABSPATH') or die();


class PasswordGeneratorWidget extends \WP_Widget
{
    /**
     * Sets up a new PasswordGenerator Widget instance.
     *
     * @since 2.8.0
     */
    public function __construct()
    {
        ...
        $widget_ops = array(
            'classname'                   => 'ag_secure_psswrd_gen_widget',
            'description'                 => __('Shows a Secure Password Generator Widget'),
            'customize_selective_refresh' => true,
        );
        
        parent::__construct('ag_secure_psswrd_gen_widget', __('Secure Password Generator Widget'), $widget_ops);
        $this->alt_option_name = 'ag_secure_psswrd_gen_widget';
    }
    ...
    public function widget($args, $instance)
    {
        ...
        require_once AG_PASSWORD_GENERATOR_PLUGIN_DIR . 'pages/passwordGeneratorTemplate.php';
    }
...
?>
        <div>
            <p><?php _e('Adds your Password Generator Widget.'); ?></p>
            <p>
